SOURCES=buffer.cpp clock.cpp color.cpp exception.cpp layer.cpp rate.cpp render/opengl.cpp render/shader.cpp shape/triangle.cpp socket.cpp network_utility.cpp point.cpp engine.cpp vertex.cpp window.cpp
SRCPATH=src/
INCPATHS=include/
LIBPATHS=lib/
OBJPATH=obj/
