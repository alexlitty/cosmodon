SOURCES=component.cpp debug.cpp event.cpp exception.cpp layer.cpp network_context.cpp network_frame.cpp network_message.cpp network_socket.cpp network_utility.cpp engine.cpp
SRCPATH=src/
INCPATHS=include/
LIBPATHS=lib/
OBJPATH=obj/
